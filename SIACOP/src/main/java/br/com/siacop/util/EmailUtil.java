...
public class EmailUtil {
	...
	public void sendConfirmMail(Usuario usuario, Consulta consulta) throws EmailException {
		String msg = "Olá caro usuário " + usuario.getNome() + " venho por meio deste, informar que sua " + "consulta com a Psicóloga do campus foi confirmada para o dia " + consulta.getDataConsulta() + " no turno da " + consulta.getPeriodoConsulta() + " às " + consulta.getHorario() + ".\n\n\n\n" + " Atenciosamente, \n" + "SIACOP Sistema de Acompanhamento de Consultas Psicológicas.\n\n\n"
